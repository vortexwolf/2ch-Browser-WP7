...
namespace DvachBrowser.Assets
{
    public class GifDecoder
    {
        ...
        protected List<object> frames; // frames read from current file
        ...
        void SetPixels(int[] pixels)
        {
            ...
            for (int th = 0; th < image.PixelHeight; th++)
            {
                for (int tw = 0; tw < image.PixelWidth; tw++)
                {
                    var argb = pixels[count++];
                    Color color = Color.FromArgb((byte)(argb >> 24), (byte)(argb >> 16), (byte)(argb >> 8), (byte)(argb >> 0));
        ...
        protected void SetPixels()
        {
            ...
            if (lastDispose > 0)
            {
                ...
                if (lastImage != null)
                {
                    ...
                    int[] prev = GetPixels(new WriteableBitmap(lastImage));
                    ...
                    if (lastDispose == 2)
                    {
                        ...
                        else
                        {
                            ...
                            c = Color.FromArgb((byte)(lastBgColor >> 24), (byte)(lastBgColor >> 16), (byte)(lastBgColor >> 8), (byte)(lastBgColor >> 0)); ;
                            //						c = new Color(lastBgColor); // use given background color
                        }
                        image.FillRectangle((int)lastRect.X, (int)lastRect.Y, (int)lastRect.Right, (int)lastRect.Bottom, c);
                    }
                }
            }
